...
jobs:
  claude-response:
    ...
    steps:
      - uses: kamekamek/claude-code-action@beta  # Fork with OAuth support
        with:
...
This action is built on top of [`kamekamek/claude-code-base-action`](https://github.com/kamekamek/claude-code-base-action).
